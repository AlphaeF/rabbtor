 ...
 * @since 0.5
 */
public class GroovyPageMetaInfo implements ApplicationContextAware
{
    ...
    public static final long LASTMODIFIED_CHECK_INTERVAL =  Long.getLong("gsp.reload.interval", 5000).longValue();
    private static final long LASTMODIFIED_CHECK_GRANULARITY =  Long.getLong("gsp.reload.granularity", 2000).longValue();
    ...
    private Encoder getCodec(String codecName) {
        return WithCodecHelper.lookupEncoder(codecName,getApplicationContext());
    }
