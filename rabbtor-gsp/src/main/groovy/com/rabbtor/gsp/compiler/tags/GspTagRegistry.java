 ...
 */
public class GspTagRegistry
{

    private static GspTagRegistry instance = new GspTagRegistry();
    ...
    private GspTagRegistry() {
        // singleton
    }

    public static GspTagRegistry getInstance() {
        return instance;
    }
    ...
    public GrailsTag newTag(String tagName) {
        ...
        try {
            ...
            throw new GspTagException("Illegal access error loading tag ["+tagName+"]: " + e.getMessage(), e);
        }
    }
}
