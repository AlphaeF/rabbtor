...
import org.grails.encoder.impl.*;
...
@CompileStatic
class StandaloneCodecLookup extends org.grails.encoder.impl.BasicCodecLookup
{
    ...
    protected List<ExpandoMetaClass> resolveMetaClasses() {
        targetClassesForMetaMethods.collect {
            Class clazz ->
            MetaClassUtils.getExpandoMetaClass(clazz)
        }
    }
}
