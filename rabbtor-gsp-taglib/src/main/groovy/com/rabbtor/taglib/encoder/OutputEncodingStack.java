    ...
    private OutputEncodingStack(OutputEncodingStackAttributes attributes) {
        outWriter = new OutputProxyWriter(writerGroup, new DestinationFactory() {
            public Writer activateDestination() throws IOException
            {
                ...
                return createEncodingWriter(stackEntry.unwrappedTarget, stackEntry.outEncoder, encodingStateRegistry, DefaultOutputEncodingSettings.OUT_CODEC_NAME);
            }
        });
        staticWriter = new OutputProxyWriter(writerGroup, new DestinationFactory() {
            public Writer activateDestination() throws IOException
            {
                ...
                return createEncodingWriter(stackEntry.unwrappedTarget, stackEntry.staticEncoder, encodingStateRegistry, DefaultOutputEncodingSettings.STATIC_CODEC_NAME);
            }
        });
        expressionWriter = new OutputProxyWriter(writerGroup, new DestinationFactory() {
            ...
            {
                StackEntry stackEntry = stack.peek();
                return createEncodingWriter(stackEntry.unwrappedTarget, stackEntry.expressionEncoder, encodingStateRegistry, DefaultOutputEncodingSettings.EXPRESSION_CODEC_NAME);
            }
        });
        taglibWriter = new OutputProxyWriter(writerGroup, new DestinationFactory() {
            ...
            {
                StackEntry stackEntry = stack.peek();
                return createEncodingWriter(stackEntry.unwrappedTarget, stackEntry.taglibEncoder != null ? stackEntry.taglibEncoder : stackEntry.defaultTaglibEncoder, encodingStateRegistry, DefaultOutputEncodingSettings.TAGLIB_CODEC_NAME);
            }
        });
