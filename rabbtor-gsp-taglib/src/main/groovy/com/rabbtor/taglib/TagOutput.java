...
public class TagOutput
{
    ...
    public final static Object captureTagOutput(TagLibraryLookup gspTagLibraryLookup, String namespace,
        ...
        if (tagLib == null) {
            throw new GspTagException("Tag [" + tagName + "] does not exist. No corresponding tag library found.");
        }
        ...
        try {
            ...
            OutputEncodingStackAttributes.Builder builder = WithCodecHelper.createOutputStackAttributesBuilder(codecSettings, outputContext.getApplicationContext());
            ...
            if (tagLibProp instanceof Closure) {
                ...
                switch (tag.getParameterTypes().length) {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        throw new GspTagException("Tag [" + tagName +
            ...
            throw new GspTagException("Tag [" + tagName + "] does not exist in tag library [" +
                    tagLib.getClass().getName() + "]");
        } finally {
