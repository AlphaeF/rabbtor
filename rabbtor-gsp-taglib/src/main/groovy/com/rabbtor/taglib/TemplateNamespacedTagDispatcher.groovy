...
class TemplateNamespacedTagDispatcher extends NamespacedTagDispatcher {
    ...
    TemplateNamespacedTagDispatcher(Class callingType, TagLibraryLookup lookup, boolean developmentMode) {
        super(TEMPLATE_NAMESPACE, callingType, lookup, developmentMode)
