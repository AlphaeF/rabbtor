...
public class TagLibraryLookup implements ApplicationContextAware, InitializingBean
{
     ...
     */
    public void registerTagLib(TagLibDescriptor taglib) {
        registerTagLib(taglib, false);
    }

    private void registerTagLib(TagLibDescriptor taglib, boolean isInitialization) {
    ...
    protected void putTagLib(Map<String, Object> tags, String name, TagLibDescriptor taglib) {
        tags.put(name, taglib.getTag(name));
    }
